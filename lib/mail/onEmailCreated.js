...
exports.onEmailCreated = functions.runWith({ secrets: ['SENDGRID_API_KEY'] }).firestore
    ...
    try {
        console.log(`[onEmailCreated] Sending email via SendGrid for: ${context.params.mailId}`);
        await sendgridService_1.sendgridService.sendEmail(Array.isArray(to) ? to : [to], subject, html);
