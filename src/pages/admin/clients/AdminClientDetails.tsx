...
export const AdminClientDetails = () => {
    ...
    const stats = [
        ...
        { label: 'Active Service', value: jobs.filter(j => [BookingStatus.INCOMING, BookingStatus.OPENED, BookingStatus.BOOKED].includes(j.status)).length, icon: Clock, color: 'emerald' },
